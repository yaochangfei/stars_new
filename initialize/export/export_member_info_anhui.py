...
def export_all_race_member():
    ...
    for race in race_cursor:
        ...
        if race.cid == '3040737C97F7C7669B04BC39A660065D':
...
def test2():
    ...
    info = RaceStatisticInfo.sync_find_one(
        {'race_cid': '3040737C97F7C7669B04BC39A660065D', 'daily_code': '2019-07-09'})
...
def test(today_code):
    ...
    # 安徽 3040737C97F7C7669B04BC39A660065D
    history_info_list = RaceStatisticInfo.sync_find(
        {'race_cid': '3040737C97F7C7669B04BC39A660065D', 'daily_code': {'$lte': today_code}}).sort(
...
def test3():
    info = RaceStatisticInfo.sync_find_one(
        {'race_cid': '3040737C97F7C7669B04BC39A660065D', 'daily_code': '2019-07-11'})
    info.sync_delete()
    today_code = '2019-07-11'
    test(today_code)
