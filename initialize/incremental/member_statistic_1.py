...
def daily_member_statistic(race_cid, daily_code):
    ...
    while True:
        try:
            ...
            if not temp_member:
                # print("normal:未找到该会员member_cid:%s" % cursor.member_cid)
                continue
            ...
            if not has_race_mapping:
                # print("normal未找到对应race_mapping,race_cid:%s,member_cid:%s" % (info.race_cid, info.member_cid))
                continue
            # 是否为当日新用户
            is_new_user(info)
            # 最后一关
            ...
            #     info.member_cid, info.is_final_passed, info.is_new_user))
            if info.is_new_user:
                print("Normal Success: member_cid:%s is_final_Pass:%s is_new:%s" % (
                    info.member_cid, info.is_final_passed, info.is_new_user))
            ...
            logger.error(e)
            print("Fail: daily_code:%s,race_cid: %s" % (daily_code, race_cid))
            member_statistic_list = []
...
def insert_from_member_amount_map(member_amount_map: dict, daily_code, race_cid):
    ...
    for member_cid, value in member_amount_map.items():
        ...
        if not temp_member:
            # print("RedPacket:未找到该会员member_cid:%s" % member_cid)
            continue
        info = MemberStatisticInfo()
        info.daily_code = daily_code
        info.race_cid = race_cid
        ...
        has_race_mapping = get_race_mapping_info(info)
        if not has_race_mapping:
            # print("RedPacket未找到对应race_mapping,race_cid:%s,member_cid:%s" % (info.race_cid, info.member_cid))
            continue
        ...
        info.draw_red_packet_count = value.get('draw_count')
        if info.is_new_user:
            print("Red Success: member_cid:%s is_final_Pass:%s is_new:%s" % (
                info.member_cid, info.is_final_passed, info.is_new_user))
...
def deal_member_without_history(race_cid, daily_code):
    ...
    while True:
        try:
            ...
            if info_special.is_new_user:
                print("No history Success: member_cid:%s is_final_Pass:%s is_new:%s" % (
                    info_special.member_cid, info_special.is_final_passed, info_special.is_new_user))
...
if __name__ == '__main__':
    ...
    # 六安
    daily_codes_list_1 = ['20190628', '20190629', '20190630', '20190701', '20190702', '20190703', '20190704',
                          '20190705',
                          '20190706', '20190707']
    # 安徽
    daily_codes_list_2 = ['20190520', '20190521', '20190522', '20190523', '20190524', '20190525', '20190526',
                          '20190527',
                          '20190528', '20190529',
                          '20190530', '20190531', '20190601', '20190602', '20190603', '20190604', '20190605',
                          '20190606',
                          '20190607', '20190608',
                          '20190609', '20190610', '20190611', '20190612', '20190613', '20190614', '20190615',
                          '20190616',
                          '20190617', '20190618']
    # 贵州
    daily_codes_list_3 = ['20190328', '20190329', '20190330', '20190331', '20190401', '20190402', '20190403',
                          '20190404',
                          '20190405', '20190406', '20190407', '20190408', '20190409', '20190410',
                          '20190411', '20190412', '20190413', '20190414', '20190415', '20190416', '20190417',
                          '20190418',
                          '20190419', '20190420', '20190421', '20190422', '20190423', '20190424',
                          '20190425', '20190426', '20190427', '20190428', '20190429', '20190430', '20190501',
                          '20190502',
                          '20190503', '20190504', '20190505', '20190506', '20190507', '20190508',
                          '20190509', '20190510', '20190511', '20190512', '20190513', '20190514', '20190515',
                          '20190516',
                          '20190517', '20190518', '20190519', '20190520', '20190521', '20190522']
    # 扬州
    daily_codes_list_4 = ['20190603', '20190604', '20190605', '20190606', '20190607', '20190608', '20190209',
                          '20190210', '20190211', '20190212', '20190213', '20190214', '20190215',
                          '20190216', '20190217', '20190218', '20190219', '20190220', '20190221', '20190222',
                          '20190223', '20190224', '20190225', '20190226', '20190227', '20190228',
                          '20190301', '20190302', '20190303', '20190304', '20190703', '20190704', '20190705',
                          '20190716', '20190717', '20190718', '20190719', '20190720', '20190721']
    daily_code_list = ['20190715', '20190716', '20190717']
    start2(_race_cid, daily_code_list)
    # task_one_day(_race_cid, '20190603')
    # info = MemberStatisticInfo.sync_find_one(
    #     {'race_cid': _race_cid, 'member_cid': '7FFC851C8BF5257B48D0C95BBD09F24F', 'daily_code': '20190703'})
    # if info:
    #     print(info.member_cid,info.is_new_user)
    # else:
    #     print('未统计')
